...
def test_create_chat_answer_chat_question_returns_response(monkeypatch):
    ...
    response = client.post("/ai/v1/chat/general/", json=request_json, headers={"User-Id": "user-1"})
...
def test_answer_chat_question_rejects_user_id_in_body(monkeypatch):
    ...
    response = client.post("/ai/v1/chat/general/", json=request_json, headers={"User-Id": "header-user"})
...
def test_answer_chat_question_returns_422_without_question(monkeypatch):
    ...
    response = client.post("/ai/v1/chat/general/", json={}, headers={"User-Id": "user-1"})
...
def test_answer_chat_question_returns_422_without_user_id(monkeypatch):
    ...
    response = client.post("/ai/v1/chat/general/", json={"question": "How do I extract invoice totals?"})
...
def test_get_chat_returns_history_from_user_id_header(monkeypatch):
    ...
    response = client.get("/ai/v1/chat/general/", headers={"User-Id": "user-1"})
...
def test_get_chat_rejects_user_id_in_body(monkeypatch):
    ...
    response = client.get("/ai/v1/chat/general/", json={"user_id": "body-user"}, headers={"User-Id": "header-user"})
...
def test_get_chat_returns_422_without_user_id(monkeypatch):
    ...
    response = client.get("/ai/v1/chat/general/")
