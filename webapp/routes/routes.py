...
from webapp.api.chat_orchestrator_v1_api import chat_orchestrator_v1
...
def init_routes(flask_app):
    ...
    flask_app.register_blueprint(chat_orchestrator_v1, url_prefix=f"{V1_PREFIX}/chat/orchestrator/")
